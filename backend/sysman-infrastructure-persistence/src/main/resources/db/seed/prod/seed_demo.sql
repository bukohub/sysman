...
INSERT INTO SYSMAN.cliente (numero_identificacion, nombre, direccion, telefono, email, creado_por)
...
-- Orden 1: CREADA
INSERT INTO SYSMAN.orden (cliente_id, tipo_orden, estado, descripcion, direccion_servicio, creado_por)
VALUES (1, 'INSTALACION', 'CREADA', 'Instalacion de medidor nuevo', 'Calle 10 # 20-30, Bogota', 'mfontana');
INSERT INTO SYSMAN.orden_historico (orden_id, estado_anterior, estado_nuevo, usuario, motivo)
